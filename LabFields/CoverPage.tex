...
\newcommand\makeinfopage{
	\begin{alwayssingle}
        ...
        \begin{minipage}[t]{\textwidth}
                ...
                105 <<Прикладна фізика та наноматеріали>> / КПІ ім. Ігоря Сікорського; уклад.  С.~М. Пономаренко, Ю.~О. Тараненко ; КПІ ім. Ігоря Сікорського.~--- Електронні текстові дані
		...
		\begin{flushleft}
			...
			\itshape Тараненко Юрій Олексійович, старший викладач
		\end{flushleft}
        \end{minipage}
