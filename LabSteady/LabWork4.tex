...
% -------- Додаткові tcolorbox-стилі для цієї роботи --------
\tcbuselibrary{skins, breakable}

% Рамка для визначень (синя)
...
% Рамка для законів/формул (зелена)
\newtcolorbox{LawBox}[1][]{
    enhanced, breakable,
    colback=green!5,
    colframe=green!50!black,
    fonttitle=\bfseries,
    title=Закон\slash Формула,
    attach boxed title to top left={xshift=6mm, yshift=-3mm},
    boxed title style={colback=green!50!black, colframe=green!50!black},
    top=6pt, #1
}

% Рамка для режимів роботи (помаранчева)
\newtcolorbox{ModeBox}[1][]{
    enhanced, breakable,
    colback=orange!8,
    colframe=orange!70!black,
    fonttitle=\bfseries,
    title=Режими роботи джерела,
    attach boxed title to top left={xshift=6mm, yshift=-3mm},
    boxed title style={colback=orange!70!black, colframe=orange!70!black},
    top=6pt, #1
}

% Рамка увага/зауваження (жовта)
...
\begin{wrapfigure}[12]{l}{0.5\linewidth}\centering
	\begin{tikzpicture}[thick, every circuit symbol/.style={thick},large circuit symbols,]
		...
		\draw ([xshift=-1.2cm]A1) node[contact] {} to[voltmeter] ++(0,-4) node[contact] {};
	\end{tikzpicture}
